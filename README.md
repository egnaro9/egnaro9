...
- 🔌 **[mcp-tools](https://github.com/egnaro9/mcp-tools)** — a **Model Context Protocol** server implemented from the spec (JSON-RPC over stdio, no SDK): a safe calculator (OWASP LLM06) and BM25 search, and *testable without a client* by speaking the real handshake to it in a subprocess.
